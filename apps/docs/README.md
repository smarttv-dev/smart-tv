...
2. Start the docs app: `pnpm -w -C apps/docs dev` or use your monorepo dev script.

Notes
- The docs are intentionally lightweight and focused on demonstrating components and usage. This app is part of an open-source project (MIT). Contributions welcome.
## Getting Started
