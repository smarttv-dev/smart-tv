...
export default function DrawerDoc(): React.ReactElement {
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2">Drawer</h1>
...
function App() {
  ...
  return (
    <>
      ...
      {/* Drawer Sides */}
      <div>
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Drawer Position</h2>
...
<Drawer open={open} side="bottom" onClose={handleClose}>
  <div>Player Controls</div>
      ...
      {/* Custom Width */}
      <div>
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Custom Width/Height</h2>
        <CodePreview
          language="tsx"
...
>
  <div>Responsive drawer</div>
      ...
      {/* With Overlay */}
      <div>
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Overlay Configuration</h2>
        <p className="text-gray-600 dark:text-gray-300 mb-4">
...
>
  <div>Darker overlay</div>
      ...
      {/* Close Behavior */}
      <div>
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Close Behavior</h2>
        <CodePreview
          language="tsx"
...
>
  <div>Multiple close options</div>
      ...
      {/* Navigation Drawer */}
      <div>
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Navigation Drawer</h2>
        <p className="text-gray-600 dark:text-gray-300 mb-4">
...
function NavigationDrawer({ open, onClose }) {
  return (
    ...
    >
      ...
      {/* Animation */}
      <div>
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Custom Animation</h2>
        <CodePreview
          language="tsx"
          code={`<Drawer
  open={open}
  ...
  <div>Smooth slide animation</div>
          ...
          <table className="min-w-full border border-gray-200 dark:border-gray-700">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              <tr>
                ...
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Controls drawer visibility</td>
              </tr>
              <tr>
              ...
              <tr>
                <td className="px-4 py-3 text-sm font-mono text-blue-600 dark:text-blue-400">side</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">left | right | top | bottom</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">left</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Side to slide from</td>
              </tr>
              <tr>
                <td className="px-4 py-3 text-sm font-mono text-blue-600 dark:text-blue-400">width</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">string</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">320px</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Drawer width (left/right)</td>
              </tr>
              <tr>
                <td className="px-4 py-3 text-sm font-mono text-blue-600 dark:text-blue-400">height</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">string</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">auto</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Drawer height (top/bottom)</td>
              </tr>
              <tr>
                <td className="px-4 py-3 text-sm font-mono text-blue-600 dark:text-blue-400">overlay</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">boolean</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">true</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Show backdrop overlay</td>
              </tr>
              <tr>
                <td className="px-4 py-3 text-sm font-mono text-blue-600 dark:text-blue-400">closeOnBackdrop</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">boolean</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">false</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Close on backdrop click</td>
              </tr>
              <tr>
                <td className="px-4 py-3 text-sm font-mono text-blue-600 dark:text-blue-400">closeOnEsc</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">boolean</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">false</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Close on Escape key</td>
              </tr>
              <tr>
      ...
      <div>
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-300">
          ...
          <li>Keep drawer width appropriate for TV screens (300-400px typically)</li>
          <li>Use left/right drawers for navigation, top/bottom for contextual content</li>
