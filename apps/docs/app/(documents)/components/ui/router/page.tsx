    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300">
          Client-side routing system with history management, dynamic routes,
          and focus-aware navigation for Smart TV apps.
        </p>
      </div>
    ...
    <div>
      ...
      <div>
        ...
        <ul className="list-inside list-disc space-y-2 text-gray-600 dark:text-gray-300">
          ...
          <li>
            Each Screen component should have selFocus for proper focus
            management
          </li>
          <li>
            Handle back button navigation with router.back() or browser back
            event
          </li>
        </ul>
      </div>
