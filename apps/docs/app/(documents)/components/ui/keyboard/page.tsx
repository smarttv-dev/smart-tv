...
export default function KeyboardDoc(): React.ReactElement {
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2">Keyboard</h1>
...
/>`}
      ...
      {/* Different Layouts */}
      <div>
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Keyboard Layouts</h2>
        <p className="text-gray-600 dark:text-gray-300 mb-4">
...
/>`}
      ...
      {/* With Suggestions */}
      <div>
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">With Auto-complete</h2>
        <p className="text-gray-600 dark:text-gray-300 mb-4">
...
/>`}
      ...
      {/* Custom Theme */}
      <div>
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Custom Theme</h2>
        <p className="text-gray-600 dark:text-gray-300 mb-4">
...
/>`}
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full border border-gray-200 dark:border-gray-700">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tr>
                <td className="px-4 py-3 text-sm font-mono text-blue-600 dark:text-blue-400">value</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">string</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">&apos;&apos;</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Current input value</td>
              </tr>
              <tr>
                <td className="px-4 py-3 text-sm font-mono text-blue-600 dark:text-blue-400">onChange</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">function</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">-</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Value change handler</td>
              </tr>
              <tr>
                <td className="px-4 py-3 text-sm font-mono text-blue-600 dark:text-blue-400">onSubmit</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">function</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">-</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Submit handler</td>
              </tr>
              <tr>
                <td className="px-4 py-3 text-sm font-mono text-blue-600 dark:text-blue-400">layout</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">string</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">qwerty</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Keyboard layout type</td>
              </tr>
              <tr>
                <td className="px-4 py-3 text-sm font-mono text-blue-600 dark:text-blue-400">placeholder</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">string</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">-</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Input placeholder text</td>
              </tr>
              <tr>
                <td className="px-4 py-3 text-sm font-mono text-blue-600 dark:text-blue-400">suggestions</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">array</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">[]</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Autocomplete suggestions</td>
              </tr>
              <tr>
                <td className="px-4 py-3 text-sm font-mono text-blue-600 dark:text-blue-400">theme</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">object</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">-</td>
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">Custom theme configuration</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div>
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-300">
          <li>Show the keyboard in a modal or drawer for better focus management</li>
          <li>Provide autocomplete suggestions to reduce typing effort</li>
          <li>Use appropriate layouts based on input type (numeric for numbers, etc.)</li>
          <li>Make keys large enough for easy navigation with remote control</li>
