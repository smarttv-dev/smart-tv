    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300">
          A container component for grouping related content within a Screen,
          with focus management capabilities.
        </p>
      </div>
    ...
    <Screen focusKey="home">
      ...
      <div>
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-300">
          ...
          to make the section non-focusable while allowing its children to
          receive focus.
        </p>
        <CodePreview
          language="tsx"
  ...
  <Button focusKey="settings">Settings</Button>
      ...
      <div>
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-300">
          ...
          to automatically focus this section when it mounts.
        </p>
        <CodePreview
          language="tsx"
  ...
  {/* When this section is focused, "play-button" will be focused first */}
      ...
      <div>
        ...
        <ul className="list-inside list-disc space-y-2 text-gray-600 dark:text-gray-300">
          ...
          <li>
            Enable trackChildren and saveLastFocusedChild for better navigation
            memory
          </li>
          <li>
