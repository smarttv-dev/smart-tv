    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300">
          Navigation menu item component with routing support, focus management,
          and remote control interaction.
        </p>
      </div>
...
>
  Home
      ...
      <div>
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-300">
          Menu items can navigate to routes using the{" "}
...
>
  TV Shows
      ...
      <div>
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-300">
          Open external links in a new window with{" "}
          <code className="rounded bg-gray-100 px-1 py-0.5 dark:bg-gray-700">
            target
          </code>{" "}
          and{" "}
          ...
          <table className="min-w-full border border-gray-200 dark:border-gray-700">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              <tr>
                ...
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">
                  Required. Unique identifier for navigation
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-mono text-sm text-blue-600 dark:text-blue-400">
                ...
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">
                  URL to navigate to on Enter press
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-mono text-sm text-blue-600 dark:text-blue-400">
              ...
              <tr>
                ...
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">
                  Link relationship (noopener, etc.)
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-mono text-sm text-blue-600 dark:text-blue-400">
              ...
              <tr>
                ...
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">
                  Called when menu receives focus
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-mono text-sm text-blue-600 dark:text-blue-400">
              ...
              <tr>
                ...
                <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">
                  Menu content or render function
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div>
        ...
        <ul className="list-inside list-disc space-y-2 text-gray-600 dark:text-gray-300">
          ...
          <li>
            ...
            for navigation to integrate with your router
          </li>
          <li>
            Group related menu items in a{" "}
            <code className="rounded bg-gray-100 px-1 py-0.5 dark:bg-gray-700">
              Navbar
            </code>{" "}
            or{" "}
          ...
          <li>
            Make menu items large enough for easy remote control selection (min
            48px height)
          </li>
        </ul>
      </div>
