    ...
    <div className="mx-auto max-w-4xl">
      ...
      <section className="mb-6">
        ...
        <ul className="mt-2 text-sm text-gray-700 dark:text-gray-300">
          <li>
            <strong>--help, -h</strong> Show help
          </li>
          <li>
            <strong>--version, -v</strong> Show CLI version
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p className="my-2 text-sm text-gray-600 dark:text-gray-300">
          The CLI copies a bundled template into your destination folder,
          updates package.json with project name and smart-tv dependencies, and
          prints next steps.
        </p>
