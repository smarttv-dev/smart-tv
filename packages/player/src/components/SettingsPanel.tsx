...
const SettingsPanel: React.FC<SettingsPanelProps> = ({
    ...
    const { ref, focusKey: panelFocusKey, focusSelf } = useFocusable({
        focusKey,
        trackChildren: true,
        ...
        <>
            ...
            <div className="player-space-y-1">
                <SettingsButton
                    ...
                    icon={
                        <svg viewBox="0 0 24 24" fill="currentColor" className="player-w-full player-h-full">
            ...
            <>
                ...
                <div className="player-flex-1 player-overflow-y-auto">
                    {activeSection === 'quality' && (
                        <VideoTrack
                            className="player-text-white player-p-0 player-bg-transparent"
                        />
                    )}
                    {activeSection === 'audio' && (
                        <AudioTrack
