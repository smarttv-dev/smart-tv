...
const PlayButtonComponent: React.FC<PlayButtonProps> = ({
  ...
  const variantClasses = {
    default:
      "player-bg-white player-bg-opacity-20 hover:player-bg-opacity-30 player-text-white",
    ghost:
      "player-bg-transparent hover:player-bg-white hover:player-bg-opacity-10 player-text-white",
    outline:
      "player-border player-border-white player-border-opacity-50 hover:player-border-opacity-100 player-bg-transparent player-text-white",
  };
  ...
  return (
    <button
      ...
      className={cn(
        ...
        focused &&
          "player-ring-2 player-ring-white player-ring-opacity-75 player-scale-110",
