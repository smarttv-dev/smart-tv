import { PlayerControllerLayout, PlayerLayoutStyle } from './PlayerControllerTypes';
...
export const youtubeLayout: PlayerControllerLayout = {
  ...
  autoHide: true,
  autoHideDelay: 4000,
  background: 'player-bg-gradient-to-t player-from-black/90 player-via-black/60 player-to-transparent',
...
export const mobileLayout: PlayerControllerLayout = {
  ...
  autoHide: true,
  autoHideDelay: 4000,
  background: 'player-bg-gradient-to-t player-from-black/80 player-to-transparent',
  padding: 'player-p-4',
  gap: 'player-gap-4',
  buttons: [
    // Center play button
...
// Layout registry
export const predefinedLayouts: Record<PlayerLayoutStyle, PlayerControllerLayout> = {
...
export const getLayoutByStyle = (style: PlayerLayoutStyle): PlayerControllerLayout => {
