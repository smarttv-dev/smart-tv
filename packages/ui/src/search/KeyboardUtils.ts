...
export const createNumericKeypad = (): KeyboardRow[] => [
  createRow([
    createKey('7'), createKey('8'), createKey('9'),
  ]),
  createRow([
    createKey('4'), createKey('5'), createKey('6'),
  ]),
  createRow([
    createKey('1'), createKey('2'), createKey('3'),
  ]),
  createRow([
    CommonKeys.backspace, createKey('0'), CommonKeys.enter,
  ]),
];
...
export const createPhoneKeyboard = (): KeyboardRow[] => [
  ...
  createRow([
    createKey('+'), createKey('0'), CommonKeys.backspace,
  ]),
  createRow([
    CommonKeys.clear, CommonKeys.enter,
  ]),
];
...
export const createUrlKeyboard = (): KeyboardRow[] => [
  createRow([
    ...CommonKeys.alphabet().slice(0, 10),
  ]),
  createRow([
    ...CommonKeys.alphabet().slice(10, 19),
  ]),
  createRow([
    ...CommonKeys.alphabet().slice(19, 26),
  ]),
  createRow([
    ...CommonKeys.numbers().slice(0, 10),
  ]),
  createRow([
    createKey('http://'),
    createKey('https://'),
...
export const createRemoteKeyboard = (): KeyboardRow[] => [
  createRow([
    ...CommonKeys.alphabet().slice(0, 9),
  ]),
  createRow([
    ...CommonKeys.alphabet().slice(9, 18),
  ]),
  createRow([
    ...CommonKeys.alphabet().slice(18, 26),
  ]),
  createRow([
    ...CommonKeys.numbers(),
  ]),
...
export const createTimeKeyboard = (): KeyboardRow[] => [
  createRow([
    createKey('0'), createKey('1'), createKey('2'),
  ]),
  createRow([
    createKey('3'), createKey('4'), createKey('5'),
  ]),
  createRow([
    createKey('6'), createKey('7'), createKey('8'),
  ]),
  createRow([
    createKey('9'), createKey(':'), CommonKeys.backspace,
  ]),
  createRow([
    CommonKeys.clear, CommonKeys.enter,
  ]),
...
export const createDateKeyboard = (): KeyboardRow[] => [
  ...
  createRow([
    createKey('0'), createKey('/'), CommonKeys.backspace,
  ]),
  createRow([
    CommonKeys.clear, CommonKeys.enter,
  ]),
...
export const createGamingKeyboard = (): KeyboardRow[] => [
  ...
  createRow([
    createKey('A'), createKey('S'), createKey('D'),
  ]),
  createRow([
    createKey('↑', { label: 'UP', width: 2 }),
  ]),
  createRow([
